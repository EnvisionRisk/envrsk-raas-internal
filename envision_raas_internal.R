...
#'                                                    simplify = TRUE)
#' }
envrsk_portfolio_hyp_rskadj_perf_regular <- function(access_token,
                                                     date,
                                                     positions,
                                                     base_cur      = NULL,
                                                     horizon       = NULL,
...
#'                                                      simplify = TRUE)
#' }
envrsk_portfolio_hyp_rskadj_perf_component <- function(access_token,
                                                       date,
                                                       positions,
                                                       base_cur      = NULL,
                                                       horizon       = NULL,
...
#' }
envrsk_update_manifest <- function(access_token,
                                   manifest){
...
#'
#' @export
envrsk_manifest_restore_to_default <- function(access_token){
...
#' }
#' @export
envrsk_workflow_weight_2_quantities <- function(access_token,
                                                dt_snapshot_weight,
...
#' }
envrsk_decorate_portfolio_with_product_type <- function(access_token,
                                                        positions,
                                                        simplify = TRUE){
...
#' }
envrsk_decorate_portfolio_with_uid <- function(access_token,
                                               positions,
                                               simplify = TRUE){
